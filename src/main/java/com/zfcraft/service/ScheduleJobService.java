package com.zfcraft.service;


import com.zfcraft.dao.ScheduleJobDaoRepository;
import com.zfcraft.model.ScheduleJobModel;
import com.zfcraft.model.ScheduleJobPo;
import com.zfcraft.model.ScheduleQuartzJob;
import com.zfcraft.utils.DateUtil;
...
//    }
    ...
    public void startSchedule(ScheduleJobModel model) {
        ...
        try {
            ...
            scheduleJobPo.setCreateTime(DateUtil.getCurrentDate());
            scheduleJobPo.setModifiedTime(DateUtil.getCurrentDate());
            scheduleJobDaoRepository.insert(scheduleJobPo);
        }catch (Exception e){
            log.error("exception:{}", e);
        }
    }
    ...
    public void scheduleUpdateCorn(ScheduleJobModel model) {
        ...
        try {
            ...
            if (!oldTime.equalsIgnoreCase(model.getCron())) {
                ...
                // 更新数据库
                scheduleJobDaoRepository.update(po);
